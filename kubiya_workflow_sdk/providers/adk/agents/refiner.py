...
"""
    ...
    async def refine_workflow(
        self, workflow_code: str, errors: List[str], context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
...
class RefinementLoop:
    ...
    def __init__(
        self, refiner: RefinementAgent, compiler: "CompilerAgent", max_iterations: int = 3
    ):
    ...
    async def refine_until_success(
        self, initial_code: str, initial_errors: List[str], context: Dict[str, Any], session: Any
    ) -> Dict[str, Any]:
        """
        ...
        for iteration in range(self.max_iterations):
            ...
            refinement_result = await self.refiner.refine_workflow(
                current_code, current_errors, context
            )
...
def create_refinement_loop(
    refiner: RefinementAgent, compiler: "CompilerAgent", max_iterations: int = 3
) -> RefinementLoop:
