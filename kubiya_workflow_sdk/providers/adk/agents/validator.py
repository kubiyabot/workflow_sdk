...
"""
    ...
    async def _after_model_callback(
        ...
        try:
            ...
            result_match = re.search(
                r"<validation_result>\s*(.*?)\s*</validation_result>", response_text, re.DOTALL
            )
            ...
            if result_match and hasattr(callback_context, "save_artifact"):
                try:
                    ...
                    version = await callback_context.save_artifact(
                        filename="validation_result.json", artifact=result_artifact
                    )
    ...
    def validate_workflow_structure(self, workflow_json: Dict[str, Any]) -> Dict[str, Any]:
        """
