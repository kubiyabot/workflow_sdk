...
Deploy in your own Kubernetes clusters:

<CardGroup cols={2}>
  <Card title="Full Control" icon="shield-check">
    Complete control over the execution environment, security policies, and resource allocation
  </Card>
  <Card title="Data Locality" icon="database">
    Direct access to your databases, APIs, and internal services without data leaving your network
  </Card>
  <Card title="Compliance" icon="certificate">
    Meet regulatory requirements by keeping all execution within your infrastructure
  </Card>
  <Card title="Custom Resources" icon="microchip">
    Use specialized hardware like GPUs, high-memory nodes, or specific instance types
  </Card>
</CardGroup>
