...
description: Kubiya provides you with everything you need to get reliable, deterministic AI automation for the enterprise
icon: rocket
---
  ...
  <Tab title="🧠 Intelligent Agents">
    ...
    def smart_incident_response():
        ...
        fix = step("auto-fix").inline_agent(
            ...
            ai_instructions="You are a remediation expert. Create scripts to fix the issues identified.",
            runners=["kubiya-hosted"]
        ).depends("analyze")
    ```
  </Tab>
